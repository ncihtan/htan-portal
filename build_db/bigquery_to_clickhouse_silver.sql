...
WITH
  centers AS (
    ...
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Records_Demographics`
  ...
  biospecimen_counts AS (
    ...
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Records_Biospecimen`
...
--   ParticipantID      <- silver_INDEXING_TABLE_All_Files_and_Records_ID_Provenance
--     Silver does not have a Released_RecordsetRows table; ParticipantID is resolved by
--     joining HTAN_BIOSPECIMEN_ID = HTAN_ASSAYED_BIOSPECIMEN_ID in the provenance table.
-- ============================================================
...
FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Records_Biospecimen` bs
LEFT JOIN (
  SELECT HTAN_ASSAYED_BIOSPECIMEN_ID, ANY_VALUE(HTAN_PARTICIPANT_ID) AS HTAN_PARTICIPANT_ID
  FROM `htan2-dcc.htan2_medallion_silver.silver_INDEXING_TABLE_All_Files_and_Records_ID_Provenance`
...
LEFT JOIN (
  ...
  FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Records_Diagnosis` d
  LEFT JOIN uberon_map um
...
-- VIEW: files
-- Phase 1 table: files
-- Sources: UNION ALL of all silver_METADATA_TABLE_All_Files_* tables,
...
WITH
  ...
  all_files AS (
    ...
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_BulkWESLevel1`
    ...
    SELECT
      ...
      WORKFLOW_VERSION,
      WORKFLOW_LINK
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_BulkWESLevel2`
    ...
    SELECT
      ...
      WORKFLOW_VERSION,
      WORKFLOW_LINK
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_BulkWESLevel3`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_MultiplexMicroscopyLevel2`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_MultiplexMicroscopyLevel3`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_MultiplexMicroscopyLevel4`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_scRNALevel1`
    ...
    SELECT
      ...
      WORKFLOW_VERSION,
      WORKFLOW_LINK
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_scRNALevel2`
    ...
    SELECT
      ...
      WORKFLOW_VERSION,
      WORKFLOW_LINK
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_scRNALevel3and4`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_DigitalPathology`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_SpatialLevel1`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_SpatialLevel3`
    ...
    SELECT
      ...
      CAST(NULL AS STRING),
      CAST(NULL AS STRING)
    FROM `htan2-dcc.htan2_medallion_silver.silver_METADATA_TABLE_All_Files_SpatialLevel4`
  ),
...
-- Phase 2 does not expose publication data in the silver_* tables.
