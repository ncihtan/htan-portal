...
class Search extends React.Component<{},IFilterProps> {
    ...
    render(){
        ...
        var self = this;
                 //@ts-ignore
        const patients = _(this.filteredFiles).filter((f)=>f.biospecimen && f.biospecimen.HTANParentID)
            ...
            return <div style={{padding:20}}>
                ...
                <ul className="nav nav-tabs">
                    <li className="nav-item">
                        <a className="nav-link" href="#">Atlas View</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active" href="#">File View</a>
                    </li>
                </ul>
                </div>
                ...
                <div className="fileTab">
                    <div className="filterControls">
                        ...
                        <label>
                            Organ: 
                        <select className="form-control" placeholder="helo"  style={{marginBottom:20, maxWidth:200}} onChange={function(e:any) {
                        ...
                        <select className="form-control"  style={{marginBottom:20, maxWidth:200}} onChange={function(e) {
                            ...
                            <div>
                                <label>
                                    Assay: 
                        <select className="form-control"  style={{marginBottom:20, maxWidth:200}} onChange={function(e:any) {
                        ...
                        <div>
                            {this.filteredFiles.length} Files
                        </div>

                        <div>
                            {_.keys(this.getGroupsByPropertyFiltered[PropNames.PrimaryDiagnosis]).length} Cancer Types
                        </div>
                        ...
                        <div>
                            { _(this.filteredFiles).map(f=>f.HTANParentBiospecimenID).uniq().value().length } Biospecimen
                        </div>
                    
                        <div>
                            {_.keys(this.getGroupsByPropertyFiltered[PropNames.TissueorOrganofOrigin]).length} Organs
                        </div>

                        <div>
                            {_.keys(this.getGroupsByPropertyFiltered[PropNames.Component]).length} Assays
                        </div>

                    </div>
                    <FileTable entities={this.filteredFiles}>
                    </FileTable>
                </div>
