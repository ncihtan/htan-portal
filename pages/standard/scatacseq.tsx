...
function Scatacseq(data: BiospecimenProps) {
  return (
    <>
      <HtanNavbar />
      <Container>
        <Row>
          <Breadcrumb className="mt-3">
            ...
            <Breadcrumb.Item href="/standards">Data Standards</Breadcrumb.Item>
            <Breadcrumb.Item active>Single Cell ATAC Seq</Breadcrumb.Item>
          </Breadcrumb>
        </Row>
        <Row>
          <span
...
export const getStaticProps: GetStaticProps = async (context) => {
  let slugs = ["data-standards-scatacseq-blurb"];
