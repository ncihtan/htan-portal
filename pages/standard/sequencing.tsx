            ...
            >
                <div className="standards-content">
                    ...
                    <p>
                        ...
                        Single Cell ATAC Seq, Bulk RNA Seq and Bulk DNA Seq.
                    </p>
                    <p>
                        ...
                        PCAWG (Pan-Cancer Analysis of Whole Genomes). Ensembl
                        gene content is essentially identical to that of GENCODE
                        (
                    ...
                    <p>
                        ...
                        ) comprehensive gene annotation file (GENCODE 34 GTF)
                        and filtered files (GENCODE 34 GTF with genes only;
                        GENCODE 34 GTF with genes only and retaining only
                        chromosome X copy of pseudoautosomal region) for HTAN
                        gene annotation. Note that HTAN also includes data
                        generated with other gene models, as the process of
                        implementing the standard is ongoing. Within HTAN
                        metadata files, the reference genome used can be found
                        in the attribute “Genomic Reference” and “Genomic
                        Reference URL”.
                    </p>
                    <p>
                        In alignment with The Cancer Genome Atlas and the NCI
                        Genomic Data Commons, sequencing data are divided into
                        four levels:
                    </p>
                    <table className="table table-data-levels">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Gene expression matrix files, VCFs, etc.
                                </td>
                            </tr>
                            <tr>
                                <td>4</td>
