...
const ToolPage: React.FunctionComponent<{ tools: Tools }> = observer(
    (props) => {
        const router = useRouter();
        const selectedFilters =
            parseSelectedFiltersFromUrl(
                (router.query as ExploreURLQuery).selectedFilters // use casting as ExploreURLQuery to use typescript to ensure URL correctness
            ) || [];
