          ...
          <Tab.Content>
            <Tab.Pane eventKey="atlasOverview">
              <Container className="mt-3">
                {wpAtlas ? (
                  <span
                    dangerouslySetInnerHTML={{ __html: wpAtlas.atlas_overview }}
                  />
                ) : (
                  "Loading..."
                )}
            ...
            <Tab.Pane eventKey="dataOverview">
              <Container className="mt-3">
                {wpAtlas ? (
                  <span
                    dangerouslySetInnerHTML={{ __html: wpAtlas.data_overview }}
                  />
                ) : (
                  "Loading..."
                )}
            ...
            <Tab.Pane eventKey="publications">
              <Container className="mt-3">
                {wpAtlas ? (
                  <span
                    dangerouslySetInnerHTML={{ __html: wpAtlas.publications }}
                  />
                ) : (
                  "Loading..."
                )}
            ...
            {synapseAtlas && (
              <>
                <Tab.Pane eventKey="clinBiospecimen">
                  <Container className="mt-3">
                    <AtlasWrapper
                      category={mergedClinicalAndBiospecimenData!}
                    />
                  </Container>
                </Tab.Pane>
            ...
            <Tab.Pane eventKey="primaryNGS">
              <Container className="mt-3">
                {wpAtlas ? (
                  <span
                    dangerouslySetInnerHTML={{ __html: wpAtlas.primary_ngs }}
                  />
                ) : (
                  "Loading..."
                )}
