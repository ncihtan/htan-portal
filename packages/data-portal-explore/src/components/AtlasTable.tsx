...
export class AtlasTable extends React.Component<IAtlasTableProps> {
    ...
    getPublicationManifest = (atlas: Atlas) => {
        return this.props.publications.find((p) => p.atlasid === atlas.htan_id);
    };
        ...
        return (this.props.filteredAtlases || this.props.synapseAtlasData).map(
            (a) =>
                ({
                    ...
                    publicationManifest: this.getPublicationManifest(a),
                } as AtlasTableData)
        );
    }
        ...
        return [
            ...
            },
            {
                ...
                cell: (atlasTableData: AtlasTableData) => {
                    if (atlasTableData.publicationManifest) {
                        return (
                            <Tooltip
                                overlay={getCiteFromPublicationManifest(
                                    atlasTableData.publicationManifest
                                )}
                            >
                                <a
                                    href={`//${
