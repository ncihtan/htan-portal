...
import IMG_CHANNEL_MAP_R4 from '../assets/img_channel_map_r4.json';
...
interface ImageChannelMap {
    metadata_version: number;
    metadata_synapseID: string;
    image_synapseID: string;
}
const IDC_MAPPINGS: {
    [key: string]: IdcImagingAsset;
} = _.keyBy<IdcImagingAsset>(IDC_IMAGING_ASSETS, 'ContainerIdentifier') as any;
const IMG_CHANNEL_METADATA_MAP: {
    [key: string]: ImageChannelMap;
} = _.keyBy<ImageChannelMap>(IMG_CHANNEL_MAP_R4, 'image_synapseID') as any;
...
interface IFileTableProps {
    ...
    imgChannelMetadataMap?: { [key: string]: ImageChannelMap };
}
...
export class FileTable extends React.Component<IFileTableProps> {
    static defaultProps = {
        ...
        imgChannelMetadataMap: IMG_CHANNEL_METADATA_MAP,
    };
                                                ...
                                                {channelMetadata && (
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            href={`https://www.synapse.org/#!Synapse:${channelMetadata.metadata_synapseID}.${channelMetadata.metadata_version}`}
                                                            target="_blank"
                                                        >
                                                            Download Channel
                                                            Metadata{' '}
