...
export enum SchemaDataId {
    ...
    AcquisitionMethodType = 'bts:AcquisitionMethodType',
    AdjacentBiospecimenIDs = 'bts:AdjacentBiospecimenIDs',
    BiospecimenType = 'bts:BiospecimenType',
    CollectionMedia = 'bts:CollectionMedia',
    Component = 'bts:Component',
    DegreeofDysplasia = 'bts:DegreeofDysplasia',
    FiducialMarker = 'bts:FiducialMarker',
    FixativeType = 'bts:FixativeType',
    HTANBiospecimenID = 'bts:HTANBiospecimenID',
    HTANParentID = 'bts:HTANParentID',
    HistologyAssessmentBy = 'bts:HistologyAssessmentBy',
    HistologyAssessmentMedium = 'bts:HistologyAssessmentMedium',
    LysisBuffer = 'bts:LysisBuffer',
    MethodofNucleicAcidIsolation = 'bts:MethodofNucleicAcidIsolation',
    MountingMedium = 'bts:MountingMedium',
    PreinvasiveMorphology = 'bts:PreinvasiveMorphology',
    ProcessingLocation = 'bts:ProcessingLocation',
    ProtocolLink = 'bts:ProtocolLink',
    SiteDataSource = 'bts:SiteDataSource',
    SlicingMethod = 'bts:SlicingMethod',
    SourceHTANBiospecimenID = 'bts:SourceHTANBiospecimenID',
    StorageMethod = 'bts:StorageMethod',
    TimepointLabel = 'bts:TimepointLabel',
    TumorInfiltratingLymphocytes = 'bts:TumorInfiltratingLymphocytes',
    AnalyteBiospecimenType = 'bts:AnalyteBiospecimenType',
    BloodBiospecimenType = 'bts:BloodBiospecimenType',
    BoneMarrowBiospecimenType = 'bts:BoneMarrowBiospecimenType',
    HTANParentBiospecimenID = 'bts:HTANParentBiospecimenID',
    OtherAcquisitionMethod = 'bts:OtherAcquisitionMethod',
    TissueBiospecimenType = 'bts:TissueBiospecimenType',
    UrineBiospecimenType = 'bts:UrineBiospecimenType',
}
...
const NUMERICAL_SCHEMA_DATA_LOOKUP: { [schemaDataId: string]: boolean } = {
    ...
    [SchemaDataId.AcquisitionMethodType]: true,
    [SchemaDataId.AdjacentBiospecimenIDs]: true,
    [SchemaDataId.BiospecimenType]: true,
    [SchemaDataId.CollectionMedia]: true,
    [SchemaDataId.Component]: true,
    [SchemaDataId.DegreeofDysplasia]: true,
    [SchemaDataId.FiducialMarker]: true,
    [SchemaDataId.FixativeType]: true,
    [SchemaDataId.HTANBiospecimenID]: true,
    [SchemaDataId.HTANParentID]: true,
    [SchemaDataId.HistologyAssessmentBy]: true,
    [SchemaDataId.HistologyAssessmentMedium]: true,
    [SchemaDataId.LysisBuffer]: true,
    [SchemaDataId.MethodofNucleicAcidIsolation]: true,
    [SchemaDataId.MountingMedium]: true,
    [SchemaDataId.PreinvasiveMorphology]: true,
    [SchemaDataId.ProcessingLocation]: true,
    [SchemaDataId.ProtocolLink]: true,
    [SchemaDataId.SiteDataSource]: true,
    [SchemaDataId.SlicingMethod]: true,
    [SchemaDataId.SourceHTANBiospecimenID]: true,
    [SchemaDataId.StorageMethod]: true,
    [SchemaDataId.TimepointLabel]: true,
    [SchemaDataId.TumorInfiltratingLymphocytes]: true,
    [SchemaDataId.AnalyteBiospecimenType]: true,
    [SchemaDataId.BloodBiospecimenType]: true,
    [SchemaDataId.BoneMarrowBiospecimenType]: true,
    [SchemaDataId.HTANParentBiospecimenID]: true,
    [SchemaDataId.OtherAcquisitionMethod]: true,
    [SchemaDataId.TissueBiospecimenType]: true,
    [SchemaDataId.UrineBiospecimenType]: true,
};
