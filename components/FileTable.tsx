...
const IMG_CHANNEL_METADATA_MAP = _.keyBy(require('../data/img_channel_map_r3.2.json'), 'image_synapseID');
                ...
                selector: (file: Entity) => {
                    ...
                    if (cellXGeneLink || bigQueryLink) {
                        ...
                        if (
                            ...
                            const channelMetadata = file.synapseId && IMG_CHANNEL_METADATA_MAP[file.synapseId];
                                                ...
                                                {channelMetadata && (
                                                    ...
                                                    >
                                                        <a
                                                            ...
                                                            href={`https://www.synapse.org/#!Synapse:${channelMetadata.metadata_synapseID}.${parseInt(channelMetadata.metadata_version)}`}
                                                        >
