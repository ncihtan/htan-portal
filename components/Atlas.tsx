...
export const AtlasWrapper: React.FunctionComponent<{ category: Category }> = ({category}) => {
    ...
    const [atlasData, setAtlasData] = useState(filteredCategory[selectedCategory]);
    const [displayCols, setDisplayCols] = useState(_.map(category[selectedCategory].data.attributes, ((k, i) => {
        return {
                name: k.name,
                enabled: true,
            }
    ...
    function handleTableToggle(e: any) {
        ...
        setDisplayCols(_.map(category[e.target.value].data.attributes, (k => {
            return {
                name: k.name,
                enabled: true,
            }
    ...
    function handleColToggle(e: any, label: string) {
        ...
        let filteredCols = category[selectedCategory].data.attributes.filter((k, i) => {
