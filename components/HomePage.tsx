  ...
  return (
    <Col key={`icon-${description}`} xs lg="2">
      <div style={{ textAlign: "center" }}>
        <div style={{ fontSize: "60px", lineHeight: "70px" }}>{text}</div>
              ...
              <Card>
                <Card.Body>
                  <div className={"card-text"}>
                    <span
                      className="card-custom-style"
                      dangerouslySetInnerHTML={{ __html: cards[2] }}
                    ></span>
                  </div>
                </Card.Body>
              </Card>
              ...
              <Card>
                <Card.Body>
                  <div className={"card-text"}>
                    <span
                      className="card-custom-style"
                      dangerouslySetInnerHTML={{ __html: cards[3] }}
                    ></span>
                  </div>
                </Card.Body>
              </Card>
              <Card>
                <Card.Body>
                  <div className={"card-text"}>
                    <span
                      className="card-custom-style"
                      dangerouslySetInnerHTML={{ __html: cards[4] }}
                    ></span>
                  </div>
                </Card.Body>
              </Card>
              <Card>
                <Card.Body>
                  <div className={"card-text"}>
                    <span
                      className="card-custom-style"
                      dangerouslySetInnerHTML={{ __html: cards[5] }}
                    ></span>
                  </div>
                </Card.Body>
              </Card>
